...
//        String Requestgroup=session.getAttribute("Requestgroup").toString();
        ...
        String TempDownloadotherDirectory="C:/temp2/";
        ...
        Key key1 = generateKey(keyvalidation);
                    System.out.println("#########"+TempDownloadotherDirectory+filename1);
                             ...
                             Decrypter.decrypt(new FileInputStream("C:/"+RequestGroup+"/"+ filename1),new FileOutputStream(TempDownloadotherDirectory+filename1));
...
//           {
        ...
        FileInputStream filetoDownload=new FileInputStream("C:/temp2/"+filename1);
